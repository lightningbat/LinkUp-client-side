...
export default function Menu({selectedTab, setSelectedTab, darkMode, toggleDarkMode}) {
    ...
    return (
        <div className="menu no-select">
                ...
                <div className='tab' id='main-icon'><img src={`src/assets/${darkMode ? "chatApp_icon_small_dark" : "icon_small"}.png`} alt="site icon" /></div>

                <div className='center-tabs groups nested-tab-container'>
                    <div className={`tab contacts tooltip ${selectedTab == "contacts" ? "selected" : ""}`} onClick={() => setSelectedTab("contacts")}>
                    ...
                    <div className={`tab groups tooltip ${selectedTab == "groups" ? "selected" : ""}`} onClick={() => setSelectedTab("groups")}>
                    ...
                    <div className={`tab settings tooltip ${selectedTab == "settings" ? "selected" : ""}`} onClick={() => setSelectedTab("settings")}>
